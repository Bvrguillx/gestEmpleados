...
public class gestion {
	...
	private void initialize() {
		...
		btnCreate.setIcon(new ImageIcon(gestion.class.getResource("/com/sun/javafx/scene/web/skin/Cut_16x16_JFX.png")));
		...
		btnExit.setIcon(new ImageIcon(gestion.class.getResource("/com/sun/javafx/scene/web/skin/Undo_16x16_JFX.png")));
		...
		btnAtras.setIcon(new ImageIcon(gestion.class.getResource("/com/sun/javafx/scene/web/skin/Undo_16x16_JFX.png")));
		...
		btnAlante
				.setIcon(new ImageIcon(gestion.class.getResource("/com/sun/javafx/scene/web/skin/Redo_16x16_JFX.png")));
			...
			public void mousePressed(MouseEvent e) {
				if (tglbtnNewToggleButton.isSelected()) {
					...
					tglbtnNewToggleButton.setIcon(new ImageIcon(
							gestion.class.getResource("/com/sun/javafx/scene/control/skin/caspian/dialog-error.png")));
				} else {
					tglbtnNewToggleButton.setText("Employee on Holidays");
					tglbtnNewToggleButton.setIcon(new ImageIcon(gestion.class
		...
		tglbtnNewToggleButton.setIcon(new ImageIcon(
				gestion.class.getResource("/com/sun/javafx/scene/control/skin/caspian/dialog-warning.png")));
		...
		JLabel sueldoLabel = new JLabel(slider.getValue() + "$ per Month");
		sueldoLabel.setFont(new Font("Franklin Gothic Heavy", Font.PLAIN, 14));
		sueldoLabel.setHorizontalAlignment(SwingConstants.CENTER);
		sueldoLabel.setBounds(526, 285, 318, 46);
		frmBvrguillxTrvpbxga.getContentPane().add(sueldoLabel);
